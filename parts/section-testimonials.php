			...
			<?php foreach ($testimonial_section["testimonials"] as $testimonial) : ?>
				...
				<div class="timeline-block">
					...
					<div class="timeline-img">
						...
						<img src="<?= $testimonial['image']['sizes']['thumbnail']; ?>" height="<?= $testimonial['image']['sizes']['thumbnail-height']; ?>" width="<?= $testimonial['image']['sizes']['thumbnail-width']; ?>" alt="<?= $testimonial['image']['alt']; ?>"/>
