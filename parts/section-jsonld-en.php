...
if ( ! $isAMP ) :
    ...
    <div class="ld-container">
        ...
        <div class="ld-tabs-mobile">
            <select name="ld-tabs" id="ld-tabs">
				<?php
				if ( have_rows( 'ld_item_en', 'option' ) ):
					while ( have_rows( 'ld_item_en', 'option' ) ) : the_row(); ?>
                        <option value="<?php the_sub_field( 'label_en', 'option' ); ?>" class="ld-tab <?php if ( get_row_index() == 1 ) {
							echo "active";
						} ?>"><?php the_sub_field( 'label_en', 'option' ); ?></option>
					<?php
					endwhile;
				endif;
				?>
			...
			if ( have_rows( 'ld_item_en', 'option' ) ):
				while ( have_rows( 'ld_item_en', 'option' ) ) : the_row(); ?>
                    <div class="ld-tab <?php if ( get_row_index() == 1 ) {
						echo "active";
					} ?>"><?php the_sub_field( 'label_en', 'option' ); ?></div>
				<?php
				endwhile;
			endif;
			?>
        ...
        <div class="ld-panels">
			...
			if ( have_rows( 'ld_item_en', 'option' ) ):
				while ( have_rows( 'ld_item_en', 'option' ) ) : the_row(); ?>
                    <div class="ld-panel">
                        <pre><?php the_sub_field( 'code_en', 'option' ); ?></pre>
                    </div>
				<?php
				endwhile;
			endif;
